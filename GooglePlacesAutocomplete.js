...
import YourLocation from '../../src/components/search/YourLocation';
            ...
            <ScrollView
              ...
              >
                <View style={[this.props.suppressDefaultStyles ? {} : defaultStyles.row, this.props.styles.row, rowData.isPredefinedPlace ? this.props.styles.specialItemRow : {}]}>
                    ...
                    <EvilIcon name="location" size={25} color="#B9B9BB" style={{ paddingRight: 0, paddingLeft: 0 }} />
                </View>
              </TouchableHighlight>
            </ScrollView>
        );
